    ...
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white mt-40">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">Making every user feel valued—no matter the size of your audience.</p>
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <a href="https://www.linkedin.com/in/sourish-harh-86298124b/" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://x.com/SourishHarh?t=u8Is4BdO_3UHP9v5JFEe4g&s=09" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://www.youtube.com/@sourishharh4430" target="_blank" rel="noreferrer">
