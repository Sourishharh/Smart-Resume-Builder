              ...
              {data.map((project,index)=>(
                 <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                     ...
                     <div className='grid  gap-3'>
                        ...
                        <textarea rows={4} value={project.description || ""} onChange={(e)=>updateProject(index,"description",e.target.value)}  placeholder='Add your project description here...' className='w-full px-3 py-2 text-sm rounded-lg resize-none '/>
